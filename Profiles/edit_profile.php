...
if ($_POST['parse_var'] == "links"){
    ...
    $sqlUpdate = mysql_query("UPDATE myMembers SET website='$website', youtube='$youtube', facebook='$facebook', twitter='$twitter' WHERE id='$id' LIMIT 1");
	if ($sqlUpdate){
...
<div class="boxHeader">
      <a href="#" onclick="return false" onmousedown="javascript:toggleSlideBox('CustBox');">
       <img src="images/toggleBtn1.png" alt="Toggle" width="22" height="30" border="0" style="position:relative; top:6px;" />&nbsp;<h2>Customized Layout</h2>
      </a> 
      </div>
      <div class="editBox" id="CustBox">
        <table width="700" align="center" cellpadding="10" cellspacing="0" style="border:#999 1px solid; background-color:#FBFBFB;">
          <form action="updateskin.php" method="post" enctype="multipart/form-data">
           <tr align="center"> 
            <select name="skins" id="skins">
 <option>Town</option>
 <option>Green_Abstract</option>
 <option>Barca</option>
 <option>Night</option>
...
<div class="boxHeader">
      <a href="../profiles/profile.php">
       <img src="images/toggleBtn1.png" alt="Toggle" width="22" height="30" border="0" style="position:relative; top:6px;" />&nbsp;<h2>Return to your Profile</h2>
      </a> 
      </div>
