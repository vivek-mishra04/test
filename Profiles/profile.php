...
<table width="100%" cellpadding="5"><tr><td width="17%" align="left"><div style="overflow:hidden; height:50px;"> ' . $lil_pic . '</div></td>
    ...
    <h1> MEMBERS</h1>
              <tbody>
              <tr>  <td>	<div style=" height:64px; overflow:hidden;">
  <a href="profile.php?id=1" title="vaibhav"><img src="members/1/image01.jpg" width="64px" border="0"></a></div></td>
              </tr>
              <tr><td>
    
	<div style=" height:64px; overflow:hidden;"><a href="profile.php?id=2" title="vivek"><img src="members/2/image01.jpg" width="64px" border="0"></a></div></td>        </tr>
    <tr><td>
    <div style=" height:64px; overflow:hidden;"><a href="profile.php?id=3" title="sid"><img src="members/3/image01.jpg" width="64px" border="0"></a></div></td>            </tr>
            </tbody></table>-->
