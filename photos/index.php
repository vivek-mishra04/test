...
<form name="uploadimage" method="POST" action="imageproc.php" onSubmit="return upimg()" enctype="multipart/form-data">
...
<table width="100%" border="1"align="center">
  <tr>
    ...
    <th width="22%" scope="col"><strong>Uploader</strong></th>
  ...
  while($row = mysql_fetch_array($result))
  {
	...
	{
    echo "<td><a href='imageproc.php?delimg=".$row["IMAGE_ID"]."'><img src='delete.png' width='10' height='10'></a></td>";
	}
    echo "</tr>";
  }
  ?>
